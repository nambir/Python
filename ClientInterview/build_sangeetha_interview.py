"""Build ClientInterview/Sangeetha-Interview.html from Sangeetha-Interview.md."""
...
MD_PATH = HERE / "Sangeetha-Interview.md"
OUT_PATH = HERE / "Sangeetha-Interview.html"
...
<title>Sangeetha interview — what you said vs right answer</title>
<style>__CSS__</style>
</head>
<body>
<div class="toolbar">
  <b>Sangeetha interview</b>
  <button type="button" id="btnPrint">Print / Save PDF</button>
  <a href="Sangeetha-Interview.md">Source</a>
  <a href="SaranyaAnswers.html">Saranya booklet</a>
...
def main() -> None:
    ...
    body = re.sub(
        r"(<h4[^>]*>What you said</h4>\s*)<blockquote>",
        r'\1<blockquote class="said">',
        body,
    )
