...
TRAINING_META = {
    ...
    10: {
        "definition": "Functions are defined with def. Python also supports functional-programming ideas: pure functions, first-class/higher-order functions, recursion, and preferring immutable data — alongside *args/**kwargs, lambda, LEGB, and closures.",
