...
REAL_LIFE: dict[int, str] = {
    ...
    14: (
        ...
        "Declare types once; Pydantic lowercases email and rejects age under 18.</p>"
        '<div class="step-pre">'
        "# INPUT\n"
        ...
        "\n"
        "# OUTPUT\n"
        "(model ready — validates on <code>model_validate</code>)"
        "</div>"
        "<p><b>2) Valid body — coercion works</b><br>"
        "String <code>\"25\"</code> becomes int <code>25</code>; email is lowercased.</p>"
        '<div class="step-pre">'
        "# INPUT\n"
        ...
        "\n"
        "# OUTPUT\n"
        "user.email → 'anu@co.com'\n"
        "user.age → 25"
        "</div>"
        "<p><b>3) Invalid age — API returns 422</b><br>"
        "Age 15 fails the <code>ge=18</code> rule before your route code runs.</p>"
        '<div class="step-pre">'
        "# INPUT\n"
    ...
    15: (
        ...
        "<p><b>1) Base <code>Account</code></b><br>"
        "Shared balance and deposit/withdraw; default <code>month_end</code> does nothing.</p>"
        '<div class="step-pre">'
        "# INPUT\n"
        "class Account:\n"
        ...
        "Child class adds 4% interest every month-end.</p>"
        '<div class="step-pre">'
        "# INPUT\n"
        ...
        "Call <code>month_end()</code> on every account; Python picks the right version.</p>"
        '<div class="step-pre">'
        "# INPUT\n"
        ...
        "\n"
        "# OUTPUT\n"
        "balances → [100, 208.0]  (base unchanged, savings +4%)"
        "</div>"
    ),
    16: (
