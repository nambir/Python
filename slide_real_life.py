...
REAL_LIFE: dict[int, str] = {
    ...
    11: (
        ...
        "cleaned → ['A', '', 'B']"
        "</div>"
        "<p><b>2) <code>filter(None, …)</code> — drop falsy / empty</b><br>"
        "Keeps only <b>truthy</b> items. Passing <code>None</code> as the function means: "
        "keep the item if the item itself is truthy "
        "(non-empty string = keep; <code>''</code> = drop).</p>"
        '<div class="step-pre">'
        "# INPUT\n"
        "cleaned = ['A', '', 'B']\n"
        "cells = list(filter(None, cleaned))\n"
        "\n"
        "# OUTPUT\n"
        "cells → ['A', 'B']"
        "</div>"
        ...
        "<tr><td><code>filter(None, …)</code></td><td>Drop falsy / empty</td><td><code>['A', 'B']</code></td></tr>"
