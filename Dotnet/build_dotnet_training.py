...
def main() -> None:
    cfg = DeckConfig(
        title=".NET Training — Skill Depth (D01–D60)",
    ...
    nav_intro = f"""
  <h1>.NET Training</h1>
  <p class="sub">Full skill-depth curriculum — {TOTAL_SLIDES} topics from Skill Matrix CSV (D01–D60)</p>
  ...
  · <a href="Skill_Depth_Matrix_I25054_Sangeetha_Rajendiran_9.csv">Skill matrix CSV</a></p>
"""
    build_deck(
        cfg=cfg,
        content=CONTENT,
